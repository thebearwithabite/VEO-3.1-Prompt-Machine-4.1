    ...
    <div className="group relative bg-gray-800 rounded-lg border border-gray-700 overflow-hidden flex flex-col">
      ...
      <div className="aspect-square bg-black relative">
        {asset.image ? (
          ...
          <label className="absolute inset-0 flex flex-col items-center justify-center cursor-pointer hover:bg-gray-700/50 focus-within:ring-2 focus-within:ring-indigo-400 transition-colors">
