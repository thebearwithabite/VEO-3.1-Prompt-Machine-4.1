    ...
    <div className="group relative bg-gray-800 rounded-lg border border-gray-700 overflow-hidden flex flex-col">
      ...
      <div className="aspect-square bg-black relative">
        {asset.image ? (
          ...
          <label className="absolute inset-0 flex flex-col items-center justify-center cursor-pointer hover:bg-gray-700/50 transition-colors focus-within:ring-2 focus-within:ring-indigo-500 focus-within:outline-none focus-within:z-10">
        ...
        {asset.image && (
           <label className="absolute bottom-2 right-2 bg-black/50 p-1.5 rounded-full cursor-pointer hover:bg-black/80 opacity-0 group-hover:opacity-100 transition-opacity focus-within:opacity-100 focus-within:ring-2 focus-within:ring-indigo-500 focus-within:outline-none focus-within:z-10">
