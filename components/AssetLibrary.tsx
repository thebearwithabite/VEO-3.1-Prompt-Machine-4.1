  ...
  return (
    <div className="group relative bg-gray-800 rounded-lg border border-gray-700 overflow-hidden flex flex-col">
      <button
        ...
        className="absolute top-1 right-1 z-10 bg-black/60 text-white rounded-full p-1 opacity-0 group-hover:opacity-100 transition-opacity focus-visible:opacity-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-400">
      ...
      <div className="aspect-square bg-black relative">
        {asset.image ? (
          ...
          <label className="absolute inset-0 flex flex-col items-center justify-center cursor-pointer hover:bg-gray-700/50 transition-colors focus-within:ring-2 focus-within:ring-indigo-400 focus-within:ring-inset rounded-lg">
        ...
        {asset.image && (
           <label className="absolute bottom-2 right-2 bg-black/50 p-1.5 rounded-full cursor-pointer hover:bg-black/80 opacity-0 group-hover:opacity-100 focus-within:opacity-100 focus-within:ring-2 focus-within:ring-indigo-400 transition-opacity">
        ...
        <div className="flex items-start justify-between gap-2 mt-1 flex-1">
            ...
            {asset.description}
             ...
             <button
                ...
                className="text-gray-500 hover:text-white transition-colors flex-shrink-0 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-400 rounded"
